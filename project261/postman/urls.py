...
urlpatterns = patterns('postman.views',
    ...
    #View for viewing all the messages of a system if you're an admin or superadmin
    url(r'^admin/inbox/(?:(?P<option>'+OPTIONS+')/)?$', AdminInboxView.as_view(), name='postman_admin_inbox'),
    url(r'^admin/delete/(?:(?P<option>'+OPTIONS+')/)?$', AdminDeleteView.as_view(), name='postman_admin_delete'),
    url(r'^admin/archive/(?:(?P<option>'+OPTIONS+')/)?$', AdminArchiveView.as_view(), name='postman_admin_archive'),
    url(r'^admin/undelete/(?:(?P<option>'+OPTIONS+')/)?$', AdminUndeleteView.as_view(), name='postman_admin_undelete'),
    url(r'^admin/view/(?P<message_id>[\d]+)/$', AdminMessageView.as_view(), name='postman_admin_view'),
    #Normal user postman views
    ...
    # Viewing messages by conversation is currently broken, so I commented this out.
